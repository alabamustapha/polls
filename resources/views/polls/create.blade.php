        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('store_poll') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('button_one') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="button_one" type="text" class="form-control" name="button_one" value="{{ old('button_one') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('button_two') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="button_two" type="text" class="form-control" name="button_two" value="{{ old('button_two') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-4">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="status" value="1" {{ old('status') ? 'checked' : '' }}> Allow voting
                                            </label>
                                        </div>
                                    </div>
                                </div>
